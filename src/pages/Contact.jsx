...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Phone, title: 'Call Us', value: '+91 7725844722, +91 9111961561', link: 'tel:+919111961561' },
  ...
  return (
    <div className="contact-page-container">
      <SEO
        title="Contact Us | Travel Agent in Indore | Sandeep Tours"
        description="Get in touch with the best travel agent in Indore for bookings, inquiries, and personalized travel planning. Tours and Travels in Indore at your service 24/7."
        keywords="contact travel agency Indore, book tempo traveller Indore, travel inquiry Indore, Sandeep Tours contact"
      />
      <div className="container section-padding">
        ...
        <div className="contact-main-grid">
          ...
          <div className="contact-sidebar">
            ...
            {/* WhatsApp CTA Card */}
            <a href="https://wa.me/917725844722?text=Hi, I want to book a cab." className="whatsapp-cta-card">
            ...
            {submitted ? (
              ...
              <form className="contact-form-ios" onSubmit={handleSubmit}>
                ...
                <div className="form-group-contact">
                  ...
                  <input type="tel" name="phone" required value={formData.phone} onChange={handleInputChange} placeholder="+91 7725844722" />
                </div>
                <div className="form-group-contact">
